...
export const metadata: Metadata = {
  title: "AutoHub - Premium Cars for Sale Online",
  description: "Find your perfect car at AutoHub. Browse luxury sedans, SUVs, trucks, and sports cars with transparent pricing and exceptional service.",
  keywords: "car sales, used cars, luxury vehicles, auto dealership, car buying",
  metadataBase: new URL("https://autohub-cars.com"),
  alternates: {
    canonical: "https://autohub-cars.com"
  },
  openGraph: {
    title: "AutoHub - Premium Cars for Sale",
    description: "Discover our handpicked selection of premium vehicles with fair pricing and excellent customer service.",
    url: "https://autohub-cars.com",
    siteName: "AutoHub",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765457942281-ruq5ylhl.jpg",
        alt: "Premium luxury car selection at AutoHub"
      }
    ]
  },
  twitter: {
    ...
    title: "AutoHub - Premium Cars for Sale",
    description: "Find your dream car at AutoHub. Transparent pricing, exceptional service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765457942281-ruq5ylhl.jpg"]
  },
  robots: {
    index: true,
    follow: true
